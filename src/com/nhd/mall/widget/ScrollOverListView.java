...
public class ScrollOverListView extends ListView implements OnScrollListener {
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN: { // 按下的时候
			...
			if (firstItemIndex == 0 && !isRecored) {
				isRecored = true;
				startY = (int) ev.getY();
				Log.v(TAG, "在down时候记录当前位置: X: " + ev.getX() + " Y: " + ev.getY());
			}
			// ===========================
			mLastY = y;
	 ...
	 * 
	 * @see com.nhd.mall.widget.ScrollOverListView.OnScrollOverListener
	 */
	 ...
	 * 滚动监听接口
	 * 
	 * @see com.nhd.mall.widget.ScrollOverListView#setOnScrollOverListener(com.nhd.mall.widget.ScrollOverListView.OnScrollOverListener)
	 * 
	 */
