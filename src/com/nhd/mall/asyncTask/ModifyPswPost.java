 ...
 */
public class ModifyPswPost {
    private OnAsyncTaskUpdateListener listener;
    private String message;
    private RegisterEntity entity;
    private Context context;

    public ModifyPswPost(Context context, RegisterEntity entity) {
        if(!AndroidServerFactory.PRODUCTION_MODEL)
            MobclickAgent.onEvent(context, "path", "/api/v1/member/pwd");
    ...
    class DownloadTask extends AsyncTaskEx<Void, Void,Object> {
        ...
        protected Object doInBackground(Void... params) {
            Object status=null;
            try {
                status = (Map<String, String>) AndroidServerFactory.getServer().modifyPswPost(entity);
            } catch (IOException e) {
                e.printStackTrace();
