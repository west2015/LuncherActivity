...
public class AddCarPost {
    ...
    private AddCarEntity car;
    private Context context;

    public AddCarPost(Context context,AddCarEntity car) {
        if(!AndroidServerFactory.PRODUCTION_MODEL)
            MobclickAgent.onEvent(context, "path", "/api/v1/car/add");
    ...
    class DownloadTask extends AsyncTaskEx<Void, Void,Object> {
        ...
        protected Object doInBackground(Void... params) {
            Object status=null;
            try {
                status = AndroidServerFactory.getServer().postAddToCar(car);
            } catch (IOException e) {
                e.printStackTrace();
