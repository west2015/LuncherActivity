...
import com.nhd.mall.activity.MyMessageActivity;
...
public class MyPushMessageReceiver extends FrontiaPushMessageReceiver {
	...
	public void onBind(Context context, int errorCode, String appid,String userId, String channelId, String requestId) {
		...
		new DbBaiduPush(context).setBaiduBindingMsg(msg);
		String responseString = "onBind errorCode=" + errorCode + " appid="
				+ appid + " userId=" + userId + " channelId=" + channelId
				+ " requestId=" + requestId;
		Log.d("onBind", responseString);
	...
	public void onMessage(Context context, String message, String customContentString) {
        ...
        String messageString = "透传消息 message=\"" + message + "\" customContentString="
				+ customContentString;
		Log.d("onMessage", messageString);

        //缓存消息
        if(message != null && message != ""){
            Message msg = ParseJson.parse(message,Message.class);
            if(msg!=null)
                new PushMsgDataHelper(context,null).insert(msg);
        }
	...
	public void onNotificationClicked(Context context, String title,
        ...
        /*if(customContentString != null && customContentString != ""){
            Message msg = ParseJson.parse(customContentString,Message.class);
            if(msg!=null)
                new PushMsgDataHelper(context,null).insert(msg);
        }*/
	...
	public void onSetTags(Context context, int errorCode,
		...
		String responseString = "onSetTags errorCode=" + errorCode + " sucessTags="
				...
				+ requestId;
		Log.d("onSetTags", responseString);
...
//		updateContent(context, responseString);
	...
	public void onDelTags(Context context, int errorCode,
		...
		String responseString = "onDelTags errorCode=" + errorCode + " sucessTags="
				+ sucessTags + " failTags=" + failTags + " requestId="
				+ requestId;
		Log.d("onDelTags", responseString);
...
//		updateContent(context, responseString);
	...
	public void onListTags(Context context, int errorCode,
		...
		Log.d("onListTags", responseString);
...
//		updateContent(context, responseString);
	...
	private void updateContent(Context context, String content) {
		...
		dbConfig.setNotificationString(notificationString);
		dbConfig.setNotificationTitle(notificationTitle);
		Intent intent = new Intent();
        intent.setClass(context.getApplicationContext(), MainActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        context.getApplicationContext().startActivity(intent);
