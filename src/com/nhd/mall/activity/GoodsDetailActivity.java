 ...
 */
public class GoodsDetailActivity extends ModelActivity implements OnAsyncTaskDataListener,View.OnClickListener,PageControl.OnScreenSwitchListener,OnAsyncTaskUpdateListener,ParemiterView.getSelectParemeter {
    ...
    private void find() {
        ...
        findViewById(R.id.rl_detail_img).setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, height));
    ...
    public void onClick(View view) {
        switch(view.getId()){
            ...
            case R.id.iv_collect:
                ...
                entity.setType(2);
                tag = COLLECT;
                new AddCollectionPost(GoodsDetailActivity.this,entity).setListener(GoodsDetailActivity.this);
                break;
            //点击进入查看商品评价
            case R.id.goodsDetail:
                ...
                new startIntent(GoodsDetailActivity.this,GoodsDetailCommentActivity.class,bundle);
                break;
            //点击进入查看商品评价
            case R.id.goodsComment:
                ...
                new startIntent(GoodsDetailActivity.this,GoodsDetailCommentActivity.class,bundleC);
                break;
...
//                Toast.makeText(GoodsDetailActivity.this, "此商品只支持商城内购买", 1).show();
    ...
    public void getDataSort(Object obj, String message, String sort) {
        ...
        if(map.get("success").equals("false")){
            ivCollect.setBackgroundResource(R.drawable.good_detail_collect_click);
        }
        else{
    ...
    public void initDetail(){
        ...
        tvCounterName.setText(productDetailEntity.getBrandName()==null?"":productDetailEntity.getBrandName());
        tvNumber.setText(productDetailEntity.getNumber()==null?"":productDetailEntity.getNumber());
        tvOldPrice.setText(productDetailEntity.getPrice()+"");
        if(productDetailEntity.getTotal()!=null){
            total = productDetailEntity.getTotal();
        }
        tvTotal.setText(productDetailEntity.getTotal()==null?"0":String.valueOf(productDetailEntity.getTotal()+"件"));
...
//        shopCarDialog.show();
    ...
    public void onScreenClick(int screen) {
        if(productImageEntity==null||productImageEntity.length==0)return;
        ...
        new startIntent(GoodsDetailActivity.this,AlbumForGalleryActivity.class,bundle);
    }
    /**
     * 初始化banner
     */
    private void updateTop(ProductImageEntity[] productImageEntity) {
        ...
        for(int i=0;i<productImageEntity.length;i++){
            ...
            View view = LayoutInflater.from(GoodsDetailActivity.this).inflate(R.layout.main_top_item, null);
            ImageView imageView = (ImageView) view.findViewById(R.id.imageViewTop);
            imageLoader.setBackgroup(productImageEntity[i].getValue(), imageView);
        ...
        for (int i = 0; i < productImageEntity.length; i++) {
            ...
            android.widget.LinearLayout.LayoutParams p = new android.widget.LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
