...
import com.nhd.mall.asyncTask.ModifyAddressPost;
 ...
 */
public class ModifyAdressActivity extends ModelActivity implements View.OnClickListener,OnAsyncTaskUpdateListener,OnAsyncTaskDataListener {
    private CustomerAddressEntity customer;
    ...
    private void find() {
        ...
        if(getIntent().getExtras()!=null){
            customer = (CustomerAddressEntity) getIntent().getExtras().getSerializable("address");
        }
        if(customer!=null){
            etName.setText(customer.getName()==null?"":customer.getName());
            etPhone.setText(customer.getMobile()==null?"":customer.getMobile());
            etAddress.setText(customer.getAddress()==null?"":customer.getAddress());
            tvArea.setText(customer.getArea()==null?"":customer.getArea());
            etZipCode.setText(customer.getZipcode()==null?"":customer.getZipcode());
        }
        select();
        selectProvince();
        selectCity();
    ...
    public void getData(Object obj, String message) {
        ...
        if(map.get("success").equals("true")){
            Toast.makeText(ModifyAdressActivity.this,"修改成功",Toast.LENGTH_SHORT).show();
            finish();
        }
    }
        ...
        switch(view.getId()){
            ...
            case R.id.tvCity:
                if(entityProvince==null||tvProvince.getText()==null||tvProvince.getText().toString().equals("")){
                    Toast.makeText(ModifyAdressActivity.this,"请先选择省份",Toast.LENGTH_SHORT).show();
                    return;
                }
                if(cityDialog!=null){
                    cityDialog.show();
                }
                new RegionGet(ModifyAdressActivity.this,entityProvince.getRegionId(),"city").setListener(ModifyAdressActivity.this);
                break;
            case R.id.tvDiqu:
                if(entityCity==null||tvCity.getText()==null||tvCity.getText().toString().equals("")){
                    Toast.makeText(ModifyAdressActivity.this,"请先选择城市",Toast.LENGTH_SHORT).show();
                    return;
                }
                if(areaDialog!=null){
                    areaDialog.show();
                }
                new RegionGet(ModifyAdressActivity.this,entityCity.getRegionId(),"area").setListener(ModifyAdressActivity.this);
                break;
            ...
            case R.id.btnSure:
                if(etName.getText()==null||etName.getText().toString().equals("")){
                    Toast.makeText(ModifyAdressActivity.this, "请填写您的姓名", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(etPhone.getText()==null||etPhone.getText().toString().equals("")){
                    Toast.makeText(ModifyAdressActivity.this,"请填写您的联系电话",Toast.LENGTH_SHORT).show();
                    return;
                }
                if(etZipCode.getText()==null||etZipCode.getText().toString().equals("")){
                    Toast.makeText(ModifyAdressActivity.this,"请填写您所在地区的邮政编码",Toast.LENGTH_SHORT).show();
                    return;
                }
                if(tvArea.getText()==null||tvArea.getText().toString().equals("")){
                    Toast.makeText(ModifyAdressActivity.this,"请填写您的所在地区",Toast.LENGTH_SHORT).show();
                    return;
                }
                if(etAddress.getText()==null||etAddress.getText().toString().equals("")){
                    Toast.makeText(ModifyAdressActivity.this,"请填写您的详细地址",Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                new ModifyAddressPost(ModifyAdressActivity.this,customer).setListener(ModifyAdressActivity.this);
                break;
        }
    }
    //弹出区域选择选项框
    private void select() {
        View view = null;
        view = LayoutInflater.from(ModifyAdressActivity.this).inflate(R.layout.region_select_dialog, null);
        tvProvince = (TextView)view.findViewById(R.id.tvProvince);
        tvCity = (TextView)view.findViewById(R.id.tvCity);
        tvDiqu = (TextView)view.findViewById(R.id.tvDiqu);
        tvProvince.setOnClickListener(ModifyAdressActivity.this);
        tvCity.setOnClickListener(ModifyAdressActivity.this);
        tvDiqu.setOnClickListener(ModifyAdressActivity.this);
        ...
        selectDialog = new Dialog(ModifyAdressActivity.this, R.style.planDialog);
    ...
    private void selectProvince() {
        View view = null;
        view = LayoutInflater.from(ModifyAdressActivity.this).inflate(R.layout.region_province_dialog, null);
        ...
        provinceDialog = new Dialog(ModifyAdressActivity.this, R.style.planDialog);
    ...
    private void selectCity() {
        ...
        cityDialog = new Dialog(ModifyAdressActivity.this, R.style.planDialog);
    ...
    private void selectArea() {
        ...
        areaDialog = new Dialog(ModifyAdressActivity.this, R.style.planDialog);
