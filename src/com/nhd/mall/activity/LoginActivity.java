...
public class LoginActivity extends ModelActivity implements View.OnClickListener,OnAsyncTaskUpdateListener{
    ...
    public void onClick(View view) {
        switch(view.getId()){
            case R.id.tvForget:
                startActivityForResult(new Intent(LoginActivity.this, GetPswActivity.class), RESULT_PSW);
                break;
            case R.id.btnRigester:
                startActivityForResult(new Intent(this, RigesterActivity.class), RESULT_CODE);
                break;
            case R.id.btLogin:
                postLoginNormol();
                break;
        ...
        switch (requestCode){
            case 1:
                if(resultCode==RESULT_OK){
                    RegisterEntity m = (RegisterEntity) data.getExtras().getSerializable("member");
