...
/**消息实体
 * Created by linchunwei on 14-4-30.
 */
public class Message implements Serializable{
    ...
    public static Message fromCursor(Cursor cursor) {
        ...
        String json = cursor.getString(cursor.getColumnIndex(PushMsgDataHelper.CacheDBInfo.JSON));
        message = ParseJson.parse(json,Message.class);
